...
def testCheckBoxFor(driver, divId, div, value):
    ...
    time.sleep(1)
    alert = driver.switch_to.alert
    assert alert.text == "Cannot send as you have not checked everything for: " + divId + ".", "wrong alert for not checked: " + divId
    alert.accept()
...
#no to
verifyWithTheFollowing("formalButton", "", "test1", "Could not send email.\nServer said: Could not find receiver: .")
verifyWithTheFollowing("informalButton", "", "test1", "Could not send email.\nServer said: Could not find receiver: .")
# to and cc repeated
verifyWithTheFollowing("formalButton", "testSpecialist1", "testSpecialist1", "Sent email to everyone except: testSpecialist1.")
verifyWithTheFollowing("informalButton", "testSpecialist1", "testSpecialist1", "Sent email to everyone except: testSpecialist1.")
#fake to
verifyWithTheFollowing("formalButton", "FAKE_EMAIL", "testSpecialist1", "Could not send email.\nServer said: Could not find receiver: FAKE_EMAIL.")
verifyWithTheFollowing("informalButton", "FAKE_EMAIL", "testSpecialist1", "Could not send email.\nServer said: Could not find receiver: FAKE_EMAIL.")
# fake cc
verifyWithTheFollowing("formalButton", "testSpecialist1", "FAKE_EMAIL", "Could not send email.\nServer said: Could not find cced person: FAKE_EMAIL.")
verifyWithTheFollowing("informalButton", "testSpecialist1", "FAKE_EMAIL", "Could not send email.\nServer said: Could not find cced person: FAKE_EMAIL.")
