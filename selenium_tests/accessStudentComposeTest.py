...
formal_system_url = "http://ugdev.cs.smu.ca/~group7/ComposeScreens/studentComposeFormal.html"     # URL for formal compose
informal_system_url = "http://ugdev.cs.smu.ca/~group7/ComposeScreens/studentComposeInformal.html" # URL for informal compose
basic_viewInbox_url = "http://ugdev.cs.smu.ca/~group7/Student_Basic/viewInbox.html"               # URL for basic view inbox
intermediate_viewInbox_url = "http://ugdev.cs.smu.ca/~group7/Student_Intermediate/viewInbox.html" # URL for intermediate view inbox
intermediateSentItems = "http://ugdev.cs.smu.ca/~group7/Student_Intermediate/sentItems.html"      # URL for intermediate sent items
