/*helps.js
Caitlin Maillet & Lydia Belachew
This file holds the JS functions that are used in HelpMain.html
Local Storage keys: 
...
*/
      ...
      */
      ...
      /*This function navigates to the main page and prompts the user to select a section from the sidebar
      Written by Caitlin Maillet
      */
      function navigate(){
        document.getElementById("content").innerHTML = 
        "<div style = \"text-align: center\"><h1>Welcome to the Help Desk!</h1>" +
        "<h2>Choose what topic you need help with from the sidebar.</h2>"
        openSideBar();
      }
    ...
    /*Saves informal style to local storage when selected by the user on the initial page
      ...
      */
      function displayToHelp() {
        closeSideBar();
        document.getElementById("content").innerHTML =
        "<div style = \"text-align: center\"><h1>To Help</h1></div><p>In the \"To\" input field, you should write the email address of the person, or people you want to send an email to." + 
      ...
      */
      function displayCcHelp() {
        closeSideBar();
        document.getElementById("content").innerHTML =
          "<div style = \"text-align: center\"><h1>CC Help</h1></div><p>Cc stands for Carbon Copy. When you Cc someone to an email, you are sending them a copy of the email.</p>" +
      ...
      */
      function displayGreetingHelp() {
        ...
        if (localStorage.getItem("style") == "informal") { 
          document.getElementById("content").innerHTML =
            "<div style = \"text-align: center\"><h1>Informal Greeting Help</h1></div><p>Because this is an informal email, meaning you have a friendly, personal relationship with " + 
        ...
        if (localStorage.getItem("style") == "formal") {
          document.getElementById("content").innerHTML = "<div style = \"text-align: center\"><h1>Formal Greeting Help</h1></div>" +
      ...
      */
      function displayBodyHelp() {
        ...
        if (localStorage.getItem("style") == "informal") {
          document.getElementById("content").innerHTML =
            "<div style = \"text-align: center\"><h1>Informal Body Help</h1></div><p>The body of an email message contains the actual content.</p><img src=\"images/bodyBox.png\">" +
        ...
        if (localStorage.getItem("style") == "formal") {
          document.getElementById("content").innerHTML =
            "<div style = \"text-align: center\"><h1>Formal Body Help</h1></div>" +
      ...
      */
      function displayClosureHelp() {
        closeSideBar();
          document.getElementById("content").innerHTML =
            "<div style = \"text-align: center\"><h1>Closure Help</h1></div><p>This is the closing of your email. Think of it as an ending of a conversation. You will need a closing " + 
      ...
      */
      function displayViewingEmailHelp() {
        closeSideBar();
        document.getElementById("content").innerHTML =
          "<div style = \"text-align: center\"><h1>Viewing Email Help</h1></div><h2>To</h2><p>This field tells you the recipient of the email. You can also email multiple people.</p><img src=\"images/ViewEmail.PNG\"width=\"800px\" />" +
          ...
          "email what the generalemail is about.</p><h2>Unread Emails</h2><p>When an email has not been read, it will be a blue color.</p><img src = \"images/unreadEmail.png\" width = \"800px\">"+
          "<h2>To Do</h2><p>There will be a\"To Do\"" +
          " button that the user can click if they feel an email is important. This will make the email orange, and<br>add a red flag on the email to remind you of the importance."+
          "</p><img src=\"images/BasicToDo.PNG\"width=\"800px\"/><h2>Done</h2><p>When you have read an email, click on the \"To Do\" button. " +
      ...
      */
      function displaySystemHelp() {
        ...
        //if difficulty is beginner, display beginner help
          if(localStorage.getItem("difficulty") == "beginner"){
            document.getElementById("content").innerHTML = 
            "<h1 style=\"text-align: center\">General System Help - Beginner System</h1><h2>Main page (Inbox)</h2><p>This the first page a user" + 
            " sees when accesing their email. The user will see a message <br>displaying the number of unread emails. Emails that have not been opened are blue,"+
             "those who have been marked as \"ToDo\" are orange," + 
            " while the ones that were opened are white.<br />At the bottom of the page are four buttons: Sent items, Compose, Help desk and Log out. </p>" +
            "<img src=\"images/BasicMainPage.png\"width=\"1000px\"/><h2>Sent Items</h2>" + 
            ...
            "width=\"1000px\"/><h2>Help Desk</h2><p>When this button is selected a new window is opened listing the various writing styles and difficulties.<br>Select the difficulty and" + 
            "email style you are using.</p><img src=\"images/BasicHelpDesk.png\" width=\"1000px\"/><br><p>After you have selected the difficulty, you can choose one of the options in the" +
            " sidebar.</p><img src = \"images/BasicHelpDesk2.png\"width=\"1000px\"><h2>Log out</h2><p>When this button is selected a message " +
          ...
          if(localStorage.getItem("difficulty") == "intermediate"){
              document.getElementById("content").innerHTML = 
              "<h1 style=\"text-align: center\">General System Help - Intermediate System</h1><h2>Main page (Inbox)</h2><p><p>This the first page a user" + 
              " sees when accesing their email. The user will see a message <br>displaying the number of unread emails. Emails that have not been opened are blue,"+
               "those who have been marked as \"ToDo\" are orange," + 
              " while the ones that were opened are white.<br/>At the top left corner of the page " +
            ...
            "family, classmates, and your peers</p><img src=\"images/BasicFormalOrInformal.png\" width=\"800px\"/><h2>Help Desk</h2><p>When this button is selected a new " +
            "window is opened listing the various writing styles and difficulties.<br>Select the difficulty and" + 
            "email style you are using.</p><img src=\"images/BasicHelpDesk.png\" width=\"1000px\"/><br><p>After you have selected the difficulty, you can choose one of the options in the" +
            " sidebar.</p><img src = \"images/BasicHelpDesk2.png\"width=\"1000px\"><h2>Log out</h2><p>When this button is selected a message box appears, clarifying if " +
          ...
          if(localStorage.getItem("difficulty") == "advanced"){
           ...
           "<h1 style=\"text-align: center\">General System Help - Advanced System</h1><h2>Main page (Inbox)</h2><p>This the first page a user sees when accesing their" + 
            ...
            "number of unread emails.<br>Emails that have not been opened are blue, while the ones that were are white. At the top left corner of the page is " + 
            ...
            "peers</p><img src=\"images/BasicFormalOrInformal.png\" width=\"1000px\"/><h2>Help Desk</h2><p>When this button is selected a new window is opened listing the various writing" +
            " styles and difficulties.<br>Select the difficulty and" + 
            "email style you are using.</p><img src=\"images/BasicHelpDesk.png\" width=\"1000px\"/><br><p>After you have selected the difficulty, you can choose one of the options in the" +
            " sidebar.</p><img src = \"images/BasicHelpDesk2.png\"width=\"1000px\">" +
      ...
      /* Function closes the sidebar by setting the width of sidebar and the page margin to 0px 
      Written by Lydia Belachew*/
